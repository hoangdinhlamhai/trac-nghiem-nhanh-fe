    ...
    <footer className="gradient-hero text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Thông tin */}
          <div>
            <h3 className="font-heading font-semibold mb-4 text-white/90">Thông tin</h3>
          ...
          {/* Danh mục */}
          <div>
            <h3 className="font-heading font-semibold mb-4 text-white/90">Danh mục</h3>
            <ul className="space-y-2.5">
              {[
          ...
          {/* Kết nối */}
          <div>
            <h3 className="font-heading font-semibold mb-4 text-white/90">Kết nối</h3>
